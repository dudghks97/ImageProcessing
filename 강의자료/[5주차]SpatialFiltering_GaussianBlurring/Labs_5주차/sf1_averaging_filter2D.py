...
# ======================================================================================================================
print("======================================================================================================================")
print("# 실습 1: OpenCV 기반의 간략형 실험 - averaging kernel을 사용한 filtering")
cv.imshow('img', img)
...
# ======================================================================================================================
print("======================================================================================================================")
print("실습 2: matplotlib, OpenCV 기반의 실험 - averaging kernel을 사용한 filtering")
# ----------------------------------------------------------------------------------------------------------------------
...
# ======================================================================================================================
print("======================================================================================================================")
print("실습 3: matplotlib 기반의 실험 - averaging kernel을 사용한 filtering")
# ----------------------------------------------------------------------------------------------------------------------
# 단계 1 - BGR to RGB 배열을 바꾼다.
# matplotlib를 이용해 화면에 영상을 출력하려면 영상 평면을 바꾸어야 한다.
# OpenCV 함수를 이용해 BGR 배열을 RGB 배열로 바꾼다.
...
print(kernel.shape) # 1차원이 아니라 2차원 커널임
